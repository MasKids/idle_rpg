// 1회성 마이그레이션: 뽑기 비용을 50으로 되돌림 — 044에서 30으로 내린 건
// 사용자 의도를 잘못 이해한 것이었고, "1회당 50은 쓰게 해야 한다"는 명확한
// 피드백에 따라 043에서 동결했던 50을 유지한다.
//
// 실행: node scripts/migrations/045-gacha-cost-revert-50.mjs
...
async function main() {
  ...
  console.log(`[migration] GachaTable.PullCostDiamond 전 레벨 ${NEW_COST}로 되돌림 완료.`)
