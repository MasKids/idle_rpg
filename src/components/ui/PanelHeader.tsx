...
export function PanelHeader({ title, onBack, toneClassName = 'text-text-primary' }: PanelHeaderProps) {
  return (
    <div className="relative flex shrink-0 items-center justify-center border-b border-surface-border py-3">
